...
const BLOG = {
  AUTHOR: 'morty', // 作者
  BIO: '专注于技术分享', // 作者简介
  LINK: 'https://b.v2wy.com', // 网站地址
  KEYWORDS: '博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'a9f09812621c4b01a8cb13570c34a1fb', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'wangyu_95@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/v2wy',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'v2wy/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHotqBg', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHotqBs4CQLZt', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "Morty's Blog", // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '专注于技术分享', // 站点描述，被notion中的页面描述覆盖
